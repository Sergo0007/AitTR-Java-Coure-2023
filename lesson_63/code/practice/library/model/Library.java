...
public class Library {
    ...
    private void init() {
        books = new ArrayList<>();
        //добавляем книги
        books.add(new Book("George Orwell","1984",2021));// 0
        ...
        books.add(new Book("George Orwell", "1984", 1949));//3
        books.add(new Book("Harper Lee", "To Kill a Mockingbird", 1960));//4
        books.add(new Book("F. Scott Fitzgerald", "The Great Gatsby", 1925));//5
        books.add(new Book("Leo Tolstoy", "War and Peace", 1869));//6
        ...
        //журнал выдачи книг
        readers.get(0).getBooks().add(books.get(0));//Иванов взял "Джордж Оруэлл"
