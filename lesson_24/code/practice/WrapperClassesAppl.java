...
public class WrapperClassesAppl {
    public static void main(String[] args) {
        ...
        //количество цифр в числе, весрия 2(делим на 10 до получения 0,цикл while)
        Integer x = 1_987_654_321;//обькт типа Integer
        ...
        System.out.println("________Constants of Wrapper Classes");
        ...
        //обраьотка деления на 0
        System.out.println("___________Not aNumber (NaN)__________");
        double a = 20.0 / 0;
        if (Double.isInfinite(a) || Double.isNaN(a)){//случилась бесконечность или несуществующее число
