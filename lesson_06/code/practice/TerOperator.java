...
public class TerOperator {
    public static void main(String[] args) {
        ...
        Scanner scanner = new Scanner(System.in); //Включаем считвывание с клавиатуры
        System.out.println("Input 1st number: ");// прглашение пользователя для ввода числа
        int number1 = scanner.nextInt(); // получение числа с клавиатуры
        System.out.println("Input 2nd number: ");// прглашение пользователя для ввода числа
