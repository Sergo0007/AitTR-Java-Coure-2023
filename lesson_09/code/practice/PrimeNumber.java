package practice;
//        Задание 3. Пользователь вводит натуральное число n.
//        Определите, является ли оно простым. Простое число - это такое число,
//        которое делится только на себя и на 1. Примеры: 2, 3, 5, 7, 11, 13, 17, 19, ...
...
public class PrimeNumber {
    public static void main(String[] args) {
        // Алгоритм:
        // любое целое число n будем пробовать делить на числа,меньше его,начиная с 2
