...
public class StringAppl {
    public static void main(String[] args) {
        ...
        str = str.concat(str1);//аналоничная операция,добавил еще раз слово world
        System.out.println(str);
        int l = str.length();//выясняем длину строки
        System.out.println("Length of string " + str + " : " + l);
        char c = str.charAt(str.length() - 1);//опраделяем последний символ в строке
        ...
        index = str.indexOf("world");// c какого индекса начинается подстрока "or"
        System.out.println(index);
        index = str.indexOf('l', 4);//ищем l, начиная с4го индекса в строке
        System.out.println(index);
        ...
        String[] words = str5.split(" ");//разделяем строку на эоементы массива типа String
