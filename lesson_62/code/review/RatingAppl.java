...
import review.dao.Ratings;
import review.dao.RatingsImpl;
...
public class RatingAppl {
    public static void main(String[] args) {
        ...
        String[] products = {"Рубашка", "Джинсы", "Куртка"};
        String[] authors = {"Автор 1", "Автор 2", "Автор 3", "Автор 4"};

        List<Review> generateReviews = new ArrayList<>();
        for (int i = 0; i < 10; i++) {
            ...
            ratings.add(review);
            generateReviews.add(review);// Добавляем отзыв для печати
    ...
    private static List<String> getProductsSortedByRating(Ratings ratings){
    ...
    private static List<String> getProductsSortedByNumberOfReviews(Ratings ratings) {
    ...
    private static List<String> getAuthorsSortedByLikes(Ratings ratings){
