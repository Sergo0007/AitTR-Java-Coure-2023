package practice.citiizens.test;

import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;
import practice.citiizens.dao.Citizens;
import practice.citiizens.dao.CitizensImpl;
import practice.citiizens.dao.CitizensSetImpl;
...
class CitizensImplTest {
    Citizens citizens;//объект citizens типа citizens
    ...
    void getAllPersonsSortedById() {
        //что метод отберет все персоны, что все они отсортированные по id
        //что id ткущего < чем id следующего
