...
public class PredicateTest {
    public static void main(String[] args) {
        ...
        Predicate<Integer> isPositive = x -> x > 0;//обьявили предмет и сразу вписали условие которое будет проверяться
        ...
        System.out.println(containsJava.test("mhgaskas Java ihgfrt"));//true
        System.out.println(containsJava.test("mhgaskas J ihgfrt"));//false
