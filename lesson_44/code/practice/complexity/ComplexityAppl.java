...
public class ComplexityAppl {
    public static void main(String[] args) {
        ...
        //будем выполнять с ним различные операции(вычисление среднего, сложение элементов, поиск мин и макс, сортировка
        ...
        */
        ...
        double avg = (double) sum / arr.length;//кастинг
        ...
        //- если идем по массиву, то сложность линейная О(n)
        // - если бинарный поиск
...
//        System.out.println(index);
        ...
        //О(log(n)) - это логарифмическая сложность(самая низкая)
