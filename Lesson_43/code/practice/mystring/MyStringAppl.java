...
public class MyStringAppl {
    public static void main(String[] args) {
        StringBuilder str = new StringBuilder("To be or not top be");
...
//        System.out.println(myString);
//
//        //задача напечатать всю строку большими буквами
...
//        System.out.println(myString);//изменилась и исходная строка - это не хорошо!
//
