...
class UserTest {
    ...
    final String password = "12345678!";// final-переменная не меняется
    ...
    void setWithoutAt() {
        ...
        assertEquals(email,user.getEmail());//если совпадут это значит что email не устанавился а остался прежним
    }
}